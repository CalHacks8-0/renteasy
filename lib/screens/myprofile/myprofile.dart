...
class MyProfile extends StatelessWidget {
  ...
  Card getApartmentCard(BuildContext context, name, address, imagePath) {
    return Card(
      elevation: 10,
      child: Padding(
                      ...
                      Column(
                        children: [
                          getApartmentCard(
                              ...
                              "assets/images/default-apartment1.jpg"),
                        ],
                      )
                    ],
                  ),
                      ...
                      Column(
                        children: [
                          getApartmentCard(
                              context,
                              "Ellipse Residence",
                              "356B Baker Street, NY",
                              "assets/images/default-apartment2.jpg"),
                          getApartmentCard(
                              context,
                              "Delta Residence",
                              "495B Baker Street, NY",
                              "assets/images/default-apartment3.jpg"),
                        ],
                      )
                    ],
                  ),
